...
cd ~
git add pintos
git commit -m "passed pointer handling"
git push origin master
cd pintos/src/userprog/build
vim grade
cd ~
git add pintos
git commit -m "passed null pointer and empty strings"
git push origin master
vim grade
cd pintos/src/userprog/build
vim grade
...
make
pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/userprog/bad-read -a bad-read -- -q  -f run bad-read
pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/userprog/bad-read -a bad-read -- -q  -f run bad-write
pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/userprog/bad-read -a bad-read -- -q  -f run bad-jump
make
pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/userprog/bad-read -a bad-read -- -q  -f run bad-jump
pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/userprog/bad-read -a bad-read -- -q  -f run bad-write
pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/userprog/bad-read -a bad-read -- -q  -f run bad-read
...
make
pintos -v -k -T 360 --qemu  --filesys-size=2 -p tests/userprog/no-vm/multi-oom -a multi-oom -- -q  -f run multi-oom
pintos -v -k -T 360 --qemu  --filesys-size=2 -p tests/userprog/no-vm/multi-oom -a multi-oom --gdb -- -q  -f run multi-oom
cd pintos/src/userprog/build
pintos -v -k -T 360 --qemu  --filesys-size=2 -p tests/userprog/no-vm/multi-oom -a multi-oom -- -q  -f --gdb run multi-oom
pintos -v -k -T 360 --qemu  --filesys-size=2 -p tests/userprog/no-vm/multi-oom -a multi-oom --gdb -- -q  -f run multi-oom
cd pintos/src/userprog/build
make
pintos -v -k -T 360 --qemu  --filesys-size=2 -p tests/userprog/no-vm/multi-oom -a multi-oom -- -q  -f run multi-oom
...
pintos -v -k -T 360 --qemu  --filesys-size=2 -p tests/userprog/no-vm/multi-oom -a multi-oom -- -q  -f run multi-oom
make
pintos -v -k -T 360 --qemu  --filesys-size=2 -p tests/userprog/no-vm/multi-oom -a multi-oom 
pintos --gdb -v -k -T 360 --qemu  --filesys-size=2 -p tests/userprog/no-vm/multi-oom -a multi-oom -- -q  -f run multi-oom
cd pintos/src/userprog/build
pintos --filesys-size=2 -p tests/userprog/no-vm/multi-oom -a multi-oom 
pintos -p tests/userprog/no-vm/multi-oom -a multi-oom
pintos --gdb -v -k -T 360 --qemu  --filesys-size=2 -p tests/userprog/no-vm/multi-oom -a multi-oom -- -q  -f run multi-oom
cd pintos/src/userprog/build
make
pintos -v -k -T 360 --qemu  --filesys-size=2 -p tests/userprog/no-vm/multi-oom -a multi-oom 
pintos --gdb -v -k -T 360 --qemu  --filesys-size=2 -p tests/userprog/no-vm/multi-oom -a multi-oom -- --gdb -q  -f run multi-oom
cd pintos/src/userprog/build
make
pintos -v -k -T 360 --qemu  --filesys-size=2 -p tests/userprog/no-vm/multi-oom -a multi-oom -- -q  -f run multi-oom
make
...
cd ~
git add pintos
gti commit -m "made some changes"
...
pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/userprog/open-normal -a open-normal -p ../../tests/userprog/sample.txt -a sample.txt -- -q  -f run open-normal
make
pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/userprog/open-normal -a open-normal -p ../../tests/userprog/sample.txt -a sample.txt -- -q  -f run open-normalmake
make
pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/userprog/open-normal -a open-normal -p ../../tests/userprog/sample.txt -a sample.txt -- -q  -f run open-normalmake
pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/userprog/open-normal -a open-normal -p ../../tests/userprog/sample.txt -a sample.txt -- -q  -f run open-normal
make
...
cd ~
git add pintos
git commit -m "fixed free(), multi-oom left"
git push origin master
cd pintos/src/usrprog/build
cd pintos/src/userprog/build
make
make chemake
make
...
cd ~
git add pintos
git commit -m "made some comments"
git push origin master
cd pintos/src/userprog/build
vim grade
cd pintos/src/userprog/build
...
make check
cd pintos
tar -czvf team17.tar.gz src document
ls
tar -czvf team17.tar.gz src document.docx
ls
cd src
cd threads
make
...
make clean
cd ..
tar -czvf [team17]_project2.tar.gz src document.docx
ls
cd cs230_project1
ls
git init
git remote add https://github.com/gudfhr95/cs230.git
git remote add origin https://github.com/gudfhr95/cs230.git
ls
git add .
...
git push origin master
cd cs230_project1
tar –cvfz 20140631.tar.gz 20140631
tar -cvfz 20140631.tar.gz 20140631
ls
tar -cvfz 20140631 20140631.tar.gz
tar -cvfz 20140631.tar.gz 20140631
ls
sl
ls
z
tar -czvf 20140631.tar.gz 20140631
ls
tar -czvf 20140631.tar.gz 20140631
cd cs230_project1
git add .
...
make
pintos -v -k -T 300 --qemu  --filesys-size=2 -p tests/vm/page-linear -a page-linear --swap-size=4 -- -q  -f run page-linear
pintos -v -k -T 300 --qemu  --filesys-size=2 -p tests/vm/page-linear -a page-linear --swap-size=4 -- -q  -f run page-linear > a.out
pintos -v -k -T 300 --qemu  --filesys-size=2 -p tests/vm/page-linear -a page-linear --swap-size=4 -- -q  -f run page-linear
make
pintos -v -k -T 300 --qemu  --filesys-size=2 -p tests/vm/page-linear -a page-linear --swap-size=4 -- -q  -f run page-linear
make
...
vim grade
cd ~
git reset --hard 4fc51d41b6a1b38d2b14038fa40e1c0f187411d2
git add .
git commit -m "project3 init"
git revert 4fc51d41b6a1b38d2b14038fa40e1c0f187411d2
git config --global user.email "gudfhr95@kaist.ac.kr"
git config --global user.name "gudfhr95"
git revert 4fc51d41b6a1b38d2b14038fa40e1c0f187411d2
git add .
git commit -m "asd"
git push origin master
...
pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/vm/page-merge-stk -a page-merge-stk -p tests/vm/child-qsort -a child-qsort --swap-size=4 -- -q  -f run page-merge-stk
make
pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/vm/page-merge-stk -a page-merge-stk -p tests/vm/child-qsort -a child-qsort --swap-size=4 -- -q  -f run page-merge-stkmake
pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/vm/page-merge-stk -a page-merge-stk -p tests/vm/child-qsort -a child-qsort --swap-size=4 -- -q  -f run page-merge-stk
git reset --hard master
make
git reset --hard masterma
make
pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/vm/page-merge-stk -a page-merge-stk -p tests/vm/child-qsort -a child-qsort --swap-size=4 -- -q  -f run page-merge-stk
make
pintos -v -k -T 60 --qemu  --filesys-size=2 -p tests/vm/page-merge-stk -a page-merge-stk -p tests/vm/child-qsort -a child-qsort --swap-size=4 -- -q  -f run page-merge-stk
...
cd ~
git add .
git commit -m "pass page-merge-stk"
git push origin master
cd pintos/src/vm/build
make
make grade
